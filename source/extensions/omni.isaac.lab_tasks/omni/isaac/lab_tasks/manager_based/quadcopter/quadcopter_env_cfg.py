...
import omni.isaac.lab_tasks.manager_based.quadcopter.mdp as mdp
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        projected_gravity = ObsTerm(func=mdp.projected_gravity_b)
